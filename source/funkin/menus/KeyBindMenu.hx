...
class KeyBindMenu extends funkin.states.MusicBeatSubstate
{
	...
	override function create()
	{
		...
		black = new FlxSprite(0, 0).makeGraphic(FlxG.width *5, FlxG.height * 5, FlxColor.BLACK);
		black.screenCenter();
		...
		keyTextDisplay = new FlxText(-75, -60, 1280, "", 72);
		...
		advertenceText.scrollFactor.set();
		add(advertenceText);
	...
	function exitSubState()
	{
		...
		FlxTween.tween(keyTextDisplay, {alpha: 0}, 0.45, {
