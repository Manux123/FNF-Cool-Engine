...
class TitleState extends states.MusicBeatState
{
	...
	override function beatHit()
	{
		...
		randomString2 = ['for the Android port LOL','SOMTHING',"you'r 3 commits :D", "Thanks for playing B)"];*/ //But can't we use the txt file version instead of this hardcoded ver? :cries:
                // shut up with your bing chingling overcharged we already put every fucking person that helped with the mod
		// also jaunen we use the hard coded one because its hard :troll:
